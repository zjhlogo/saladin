...
public:
    QSize sizeHint() const { return QSize(m_textEdit->lineNumberAreaWidth(), 0); }

protected:
    void paintEvent(QPaintEvent* e) { m_textEdit->lineNumberAreaPaintEvent(e); }
...
{
    if (m_lineNumbers) m_lineNumberArea->update();
}
